    ...
    <div class="" style="min-height: 100%;">
      ...
      <section class="content" style="background-color:blue;">
        <div class="container-fluid" style="margin-top:100px;">
			...
			<div class="d-flex flex-column p-2 col-12" style="background-color:red">
				<h5 style="margin-bottom:15px;">Lakukan pencarian dengan menggunakan pilihan berikut ini</h5>
				<h6>Berikut pilihan lainnya yang dapat diisi sesuai dengan kriteria yang sangat anda pertimbangkan dalam memilih layanan pendidikan ABK</h6>
				<div class="p-5">

					<div class="d-flex flex-column">
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Bentuk sekolah</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Status sekolah</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Akreditasi sekolah</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Waktu penyelenggara sekolah</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Kurikulum Sekolah</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Metode penyampaian materi pembelajaran</div>
							<div class="d-flex p-2 bg-danger" style="width:100%">
								<div class="d-flex flex-column bg-primary" style="width:100%">
									<div class="custom-control custom-checkbox bg-danger"> 
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Metode monitoring dan evaluasi perkembangan anak</div>
							<div class="d-flex p-2 bg-danger" style="width:100%">
								<div class="d-flex flex-column bg-primary" style="width:100%">
									<div class="custom-control custom-checkbox bg-danger"> 
										<input class="custom-control-input" type="checkbox" id="customCheckbox1" value="option1">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Kegiatan sekolah yang dapat diikuti AKB</div>
							<div class="d-flex p-2 bg-danger" style="width:100%">
								<div class="d-flex flex-column bg-primary" style="width:100%">
									<div class="custom-control custom-checkbox bg-danger"> 
										<input class="custom-control-input" type="checkbox" id="customCheckbox1" value="option1">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Sarana & prasana umum yang disediakan sekolah</div>
							<div class="d-flex p-2 bg-danger" style="width:100%">
								<div class="d-flex flex-column bg-primary" style="width:100%">
									<div class="custom-control custom-checkbox bg-danger"> 
										<input class="custom-control-input" type="checkbox" id="customCheckbox1" value="option1">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Sarana & prasarana khusus yang disediakan sekolah</div>
							<div class="d-flex p-2 bg-danger" style="width:100%">
								<div class="d-flex flex-column bg-primary" style="width:100%">
									<div class="custom-control custom-checkbox bg-danger"> 
										<input class="custom-control-input" type="checkbox" id="customCheckbox1" value="option1">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Teknologi yang disediakan sekolah</div>
							<div class="d-flex p-2 bg-danger" style="width:100%">
								<div class="d-flex flex-column bg-primary" style="width:100%">
									<div class="custom-control custom-checkbox bg-danger"> 
										<input class="custom-control-input" type="checkbox" id="customCheckbox1" value="option1">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Penerimaan sekolah terhadap ABK</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Syarat perlu ada tidaknya pendamping</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Ketersediaan hubungan dengan sekolah lain</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Ketersediaan program penempatan ganda</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Ketersediaan dukungan spesialis</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Ketersediaan pembekalan kepada siswa lainnya dalam mendidik mereka untuk dapat menerima siswa berkebutuhan khusus</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Ketersediaan asosiasi orang tua dan guru</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
						...
						<div class="d-flex p-2 bg-info justify-content-center">
							<div class="p-2 flex-fill bg-warning" style="width:100%">Ketersediaan forum pandangan orang tua</div>
							<div class="p-2 flex-fill bg-primary" style="width:100%">
